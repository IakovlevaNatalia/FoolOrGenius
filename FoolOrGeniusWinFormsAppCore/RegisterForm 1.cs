    ...
    public partial class RegisterForm : Form
    {
        ...
        private void signUpButton_Click(object sender, EventArgs e)
        {
            ...
            if (ok)
            {
                ...
                if (!IsValidEmail(userEmailField.Text))
                {
                    MessageBox.Show("Invalid email address.", "Validation Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    ok = false;
                }
                //else
                //{
                //    MessageBox.Show("Valid email address", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Information);
                //}
            }
